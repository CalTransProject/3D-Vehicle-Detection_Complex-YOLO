...
#         box1 = box1.buffer(0)
#         if not box1.is_valid:
#             warnings.warn(f"Polygon at index {idx_self} is still invalid after buffer(0).", RuntimeWarning)
#
#     if np.isnan(box1.area) or np.isinf(box1.area):
#         warnings.warn(f"Polygon at index {idx_self} has NaN or Inf area.", RuntimeWarning)
...
#             box2 = box2.buffer(0)
#             if not box2.is_valid:
#                 warnings.warn(f"Polygon at index {idx} is still invalid after buffer(0).", RuntimeWarning)
#
#         if np.isnan(box2.area) or np.isinf(box2.area):
#             warnings.warn(f"Polygon at index {idx} has NaN or Inf area.", RuntimeWarning)
#             continue
#
