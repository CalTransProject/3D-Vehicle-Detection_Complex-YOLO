...
from data_process.practice_dataloader import create_val_dataloader
from models.model_utils import create_model
from utils.misc import AverageMeter, ProgressMeter
from utils.evaluation_utils_practice import post_processing, get_batch_statistics_rotated_bbox, ap_per_class, load_classes, post_processing_v2
...
def parse_eval_configs():
    ...
    parser.add_argument('--classnames-infor-path', type=str, default='../dataset/practice/classes_names.txt',
    ...
    configs.dataset_dir = os.path.normpath(os.path.join(configs.working_dir, 'dataset', 'practice'))
...
if __name__ == '__main__':
    ...
    print("\nStart computing mAP...\n")
    print("Pretrained Path:", configs.pretrained_path)
    print("Dataset Directory:", configs.dataset_dir)
