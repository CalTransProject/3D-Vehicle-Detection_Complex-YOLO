...
-----------------------------------------------------------------------------------
# Description: This script for the custom dataset (smaller portion of the KITTI dataset
...
from data_process import transformation_custom, custom_bev_utils, custom_data_utils
...
class CustomDataset(Dataset):
    ...
    def get_calib(self, idx):
        ...
        return custom_data_utils.Calibration(calib_file)

    def get_label(self, idx):
        label_file = os.path.join(self.label_dir, '{:06d}.txt'.format(idx))
        # assert os.path.isfile(label_file)
        return custom_data_utils.read_label(label_file)
