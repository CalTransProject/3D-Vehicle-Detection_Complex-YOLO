...
-----------------------------------------------------------------------------------
# Description: This script for the practice dataset (smaller portion of the KITTI dataset
...
class PracticeDataset(Dataset):
    ...
    def load_img_only(self, index):
        ...
        b = practice_bev_utils.removePoints(lidarData, cnf.boundary)
        rgb_map = practice_bev_utils.makeBVFeature(b, cnf.DISCRETIZATION, cnf.boundary)
    ...
    def get_calib(self, idx):
        ...
        return practice_data_utils.Calibration(calib_file)

    def get_label(self, idx):
        label_file = os.path.join(self.label_dir, '{:06d}.txt'.format(idx))
        # assert os.path.isfile(label_file)
        return practice_data_utils.read_label(label_file)
