...
def print_configs(configs):
    for attribute in dir(configs):
        # Filters out private attributes/methods and special methods
        if not attribute.startswith('_') and not callable(getattr(configs, attribute)):
            print(f"{attribute}: {getattr(configs, attribute)}")
...
def create_val_dataloader(configs):
    ...
    # Print out the contents of configs
    print("Configs being used:")
