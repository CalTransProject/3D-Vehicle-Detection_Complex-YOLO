...
class Object3D(object):
    ...
    def __init__(self, label_file_line):
        ...
        self.xctr = float(data[12])  # Object's center x
        self.yctr = float(data[13])  # Object's center y
...
def main():
    ...
    label_file = os.path.join(dataset_dir, "label_2_testing3", f"{sample_id}.txt")
