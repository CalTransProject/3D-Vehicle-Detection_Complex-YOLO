...
def parse_eval_configs():
    ...
    parser.add_argument('--classnames-infor-path', type=str, default='../dataset/custom/classes_names.txt',
    ...
    configs.dataset_dir = os.path.normpath(os.path.join(configs.working_dir, 'dataset', 'custom'))
